...
```{r}
## 4.2 joing the csv file to our shapefile
...
g <- rgdal::readGDAL(fname = "/Users/huangrh/MyGit/geoR/example/data/anom.2000.03.tiff")  #Read in a geoTiff of rainfall anomolies
